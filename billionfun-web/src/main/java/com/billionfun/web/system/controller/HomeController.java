package com.billionfun.web.system.controller;
...
public class HomeController {
    ...
    @GetMapping("/home")
    public CustomerVo index(){
        CustomerVo customerVo = customerCenterFeignApi.getCustomerById(1l);
        return customerVo;
    }
